...
const DynamicForm: React.FC<DynamicFormProps> = ({
    ...
    return (
        <form
            ...
            className="w-full max-w-3xl mx-auto bg-linear-to-br from-white to-gray-50 rounded-2xl 
                shadow-2xl border border-gray-100 h-[450px] flex flex-col transition-all duration-300"
        >
            {/* Fixed Header */}
            ...
            <div className="p-8 pt-6 shrink-0 border-t border-gray-100 bg-white/80 backdrop-blur-sm">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                        type="submit"
                        className="ml-auto px-8 py-3 bg-linear-to-r from-[#FF385C] to-[#e03050] 
