    ...
    <Controller
      ...
      render={({ field, fieldState: { error } }) => {
        const baseClassName = `w-full bg-white border-2 border-gray-200 rounded-xl px-4 py-3
                text-gray-900 shadow-sm hover:shadow-md focus:ring-2 focus:ring-brand/30
        ...
        return (
          <div className={`flex flex-col space-y-2.5 ${className}`}>
            ...
            {type === "checkbox_single" && (
              <label className="flex items-center gap-3 cursor-pointer bg-white border-2 border-gray-200 rounded-xl p-4 hover:shadow-md hover:border-brand transition-all">
                <input
                  type="checkbox"
